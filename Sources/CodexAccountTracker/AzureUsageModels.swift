...
enum CodexLogUsageProvider: String, Equatable, Codable {
    ...
    var sessionCounterLabel: String {
        ...
        case .cursor: return "Cursor conversations"
        }
    }
    ...
    var costLabel: String {
        switch self {
        case .azure, .openai, .claudeCode, .cursor: return "Est. cost"
    ...
    var costShortLabel: String {
        switch self {
        case .azure, .openai, .claudeCode, .cursor: return "Est."
    ...
    var unknownEndpointWarning: String {
        ...
        case .claudeCode, .lmStudio, .cursor:
            return ""
        }
    }
}
